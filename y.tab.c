...
{
       0,    36,    36,    40,    41,    44,    48,    58,    62,    63,
      67,    74,    75,    79,    80,    85,    93,   103,   108,   114,
     120,   126,   130
};
#endif
...
static const char *const yytname[] =
{
  ...
  "command_and_args", "arg_list", "io_list", "argument", "command_word",
...
{
       0,     0,    16,     8,     0,     0,     3,     5,    14,    12,
       9,     1,     4,     0,    10,     0,     0,     0,     7,     0,
      21,     0,    13,    15,    11,    17,    18,    19,     6,    20
};
...
{
      12,    -2,     1,     1,     2,     2,    10,    11,    23,     3,
       3,    25,    26,     0,    28,    15,    16,    17,    18,    19,
      20,    21,    27,    29
};
...
{
       0,     1,     3,     8,    13,    14,    15,    16,    17,    21,
       8,     0,    15,    19,    18,     5,     6,     7,     8,     9,
      10,    11,    22,     3,    20,     3,     3,     3,    15,     3
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6: /* simple_command: command_and_args io_list PIPE command  */
#line 48 "shell.y"
                                              {
...
#line 1174 "y.tab.c"
  ...
  case 7: /* simple_command: command_and_args io_list NEWLINE  */
#line 58 "shell.y"
                                           {
		printf("   Yacc: Execute command\n");
		Command::_currentCommand.execute();
...
#line 1228 "y.tab.c"
  ...
  case 18: /* iomodifier_opt: GREATER WORD  */
#line 108 "shell.y"
                       {
		printf("   Yacc: insert output \"%s\"\n", (yyvsp[0].string_val));
		Command::_currentCommand._catFile = (yyvsp[0].string_val);
	}
#line 1237 "y.tab.c"
    break;
...
#line 1246 "y.tab.c"
  ...
  case 20: /* iomodifier_opt: ERROR WORD  */
#line 120 "shell.y"
                     {
...
#line 1256 "y.tab.c"
  ...
  case 21: /* iomodifier_opt: BACKGROUND  */
#line 126 "shell.y"
                     {
